  ...
  return ( 
    <>
     <div
        ...
        className="bg-[#111] border border-[#1e1e1e] rounded-xl p-5 hover:border-[#c8a97e]/20 transition-all flex justify-center h-60 max-w-100 items-center cursor-pointer"
      >
